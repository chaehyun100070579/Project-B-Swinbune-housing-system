            ...
            "
                    <table border='1'  id='zctb' class='table table-bordered' cellspacing='0' width='90%'>
                     <tbody>
                                            ...
                                            <tr>
                                                <td colspan='6'><h4>Check-in Info</h4></td>
                                            </tr>
                                             <tr>
                                ...
                                <table class="Form_Table" border="1" width="660" cellspacing="0">
                                    <tr><h3>STUDENT\'S DECLARATION</h3></tr>
                                        ...
                                        <tr>
                                            ...
                                            <td width="90" class="content_black1"><input type="text" name="StudID" style="width:80px;background-color:#FFFFAA;" onfocus="changeInColor(this);" onblur="changeColorBack(this);" maxlength="9" onkeyup="displayStudEmail(this)" name="studentid" value='.$row->studentid.' readonly /></td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" class="content_black1"><b>Check In Time</b> &nbsp;
                                            <select name="CheckinTime" style="background-color:#FFFFAA;" onfocus="changeInColor(this);" onblur="changeColorBack(this);">
                                                <option value=""> </option>
